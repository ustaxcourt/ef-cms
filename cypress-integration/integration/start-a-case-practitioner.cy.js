...
describe('Start a case as a practitioner', () => {
  it('go to the practitioner dashboard and expect that a case list table is displayed with five cases', () => {
  ...
  it('expect the case list to be displayed with six items now', () => {
    getCaseList().should('exist');
    getCaseList().should('have.length', 6);
  });
});
