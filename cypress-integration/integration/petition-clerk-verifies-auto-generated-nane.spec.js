...
const verifyPdfViewerFunctionality = ({ docketTitle }) => {
  describe('verify functionality of buttons in draft pdf viewer', () => {
    // it('should render a full screen pdf of a draft item', () => {
    ...
    //   });
    // });
    it('should add draft item to docket entry and serve the draft item', () => {
      ...
      // check for document description
      cy.get('input#free-text').should('have.value', docketTitle);
    ...
    // it('edits an existing draft item', () => {
...
describe('Verify functionality of autogenerated NANE after serving a case', function () {
  ...
  verifyPdfViewerFunctionality({
    docketTitle: 'Notice of Attachments in the Nature of Evidence',
    editorBodyText:
