...
mkdir -p coverage
API_REGION=${region} API_STAGE=${slsStage} API_TARGET=${restApiId} ./node_modules/.bin/artillery run -v "{\"token\": \"$token\"}" ./smokeTest.yml --output ./coverage/artillery_smoke_test.json
