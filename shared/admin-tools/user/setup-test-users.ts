...
const setupCourtUsers = async () => {
  const userSet: Array<[number, string, string]> = [
    ...
    [2, 'chambers', 'ashfordsChambers'],
    [2, 'chambers', 'buchsChambers'],
    [2, 'chambers', 'carluzzosChambers'],
    [2, 'chambers', 'cohensChambers'],
    [2, 'chambers', 'colvinsChambers'],
    [2, 'chambers', 'copelandsChambers'],
    [2, 'chambers', 'friedsChambers'],
    [2, 'chambers', 'foleysChambers'],
    [2, 'chambers', 'galesChambers'],
    [2, 'chambers', 'goekesChambers'],
    [2, 'chambers', 'greavesChambers'],
    [2, 'chambers', 'gustafsonsChambers'],
    [2, 'chambers', 'halpernsChambers'],
    [2, 'chambers', 'holmesChambers'],
    [2, 'chambers', 'jonesChambers'],
    [2, 'chambers', 'kerrigansChambers'],
    [2, 'chambers', 'landysChambers'],
    [2, 'chambers', 'laubersChambers'],
    [2, 'chambers', 'leydensChambers'],
    [2, 'chambers', 'marshallsChambers'],
    [2, 'chambers', 'marvelsChambers'],
    [2, 'chambers', 'morrisonsChambers'],
    [2, 'chambers', 'negasChambers'],
    [2, 'chambers', 'panuthosChambers'],
    [2, 'chambers', 'parisChambers'],
    [2, 'chambers', 'pughsChambers'],
    [2, 'chambers', 'ruwesChambers'],
    [2, 'chambers', 'siegelsChambers'],
    [2, 'chambers', 'thorntonsChambers'],
    [2, 'chambers', 'torosChambers'],
    [2, 'chambers', 'urdasChambers'],
    [2, 'chambers', 'vasquezsChambers'],
    [2, 'chambers', 'weilersChambers'],
    [2, 'chambers', 'wellsChambers'],
  ];
