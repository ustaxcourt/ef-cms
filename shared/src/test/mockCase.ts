...
export const MOCK_CASE_WITH_PETITIONER_DECEASED_SPOUSE = {
  caseCaption: 'Living Petitioner & Deceased Petitioner, Deceased, Petitioners',
  caseType: CASE_TYPES_MAP.other,
  docketEntries: MOCK_DOCUMENTS,
  docketNumber: '110-23',
  entityName: 'Case',
  ...
  petitioners: [
    {
      address1: '123 Main St',
      city: 'Somewhere',
      contactId: 'b84acb19-008f-4911-bfb6-773ca4020464',
      contactType: CONTACT_TYPES.petitioner,
      countryType: COUNTRY_TYPES.DOMESTIC,
      email: 'petitioner@example.com',
      name: 'Living Petitioner',
      phone: '1234567',
      postalCode: '12345',
      serviceIndicator: SERVICE_INDICATOR_TYPES.SI_ELECTRONIC,
      state: 'TN',
    },
    {
      address1: '123 Main St',
      city: 'Somewhere',
      contactId: '91c5fd77-d1dc-46ae-a847-0f539188e47f',
      contactType: CONTACT_TYPES.petitioner,
      countryType: COUNTRY_TYPES.DOMESTIC,
      email: 'petitioner@example.com',
      inCareOf: 'Living Petitioner',
