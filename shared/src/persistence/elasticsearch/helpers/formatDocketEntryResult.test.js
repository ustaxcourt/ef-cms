const { formatDocketEntryResult } = require('./formatDocketEntryResult');
...
describe('formatDocketEntryResult', () => {
  ...
  it('should unmarshall the case when it is not found in the caseMap', async () => {
    const mockCaseMap = {};
    ...
    const results = await formatDocketEntryResult({
      ...
      sourceUnmarshalled: mockCaseUnmarshalled,
    });
