...
describe('generateChangeOfAddress', () => {
  ...
  it('should not create a change of address when the case is sealed', async () => {
    mockCaseWithPrivatePractitioner.isSealed = true;
    mockCaseWithPrivatePractitioner.sealedDate = Date.now();
