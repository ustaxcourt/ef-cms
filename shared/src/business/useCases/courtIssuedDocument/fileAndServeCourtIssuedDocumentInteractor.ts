...
export const fileAndServeCourtIssuedDocumentInteractor = async (
  ...
  const autogeneratedDeadlineDescription =
    autogenerateDeadlineDescription(docketEntryToServe);
  if (autogeneratedDeadlineDescription) {
    await autoGenerateDeadline({
      applicationContext,
      deadlineDate: form.date,
      description: autogeneratedDeadlineDescription,
      subjectCaseEntity,
    });
  }
