...
describe('fileAndServeCourtIssuedDocumentInteractor', () => {
  ...
  it('should create a deadline on the subject case when docket entry is an Order For Filing Fee', async () => {
    ...
    caseRecord.docketEntries.push(mockOrderForFilingFee);

    await fileAndServeCourtIssuedDocumentInteractor(applicationContext, {
      clientConnectionId: mockClientConnectionId,
      docketEntryId: mockOrderForFilingFee.docketEntryId,
      docketNumbers: [caseRecord.docketNumber],
  ...
  it('should create a deadline on the subject case when docket entry is an Order For Amended Petition', async () => {
    ...
    caseRecord.docketEntries.push(mockOrderForAmendedPetition);

    const mockOrderForAmendedPetitionForm = {
      date: '2030-01-20T00:00:00.000Z',
    ...
    await fileAndServeCourtIssuedDocumentInteractor(applicationContext, {
      clientConnectionId: mockClientConnectionId,
      docketEntryId: mockOrderForAmendedPetition.docketEntryId,
      docketNumbers: [caseRecord.docketNumber],
      form: mockOrderForAmendedPetitionForm,
      subjectCaseDocketNumber: caseRecord.docketNumber,
    });
    ...
    expect(
      ...
      deadlineDate: mockOrderForAmendedPetitionForm.date,
      description:
  ...
  it('should NOT create a deadline on the non subject case when docket entry is an Order For Amended Petition', async () => {
    const mockOrderForAmendedPetition = {
      ...mockDocketEntryWithWorkItem,
      docketEntryId: '3f82da02-e88c-4f8d-ba06-d6c1b8c109d5',
      eventCode: orderForAmendedPetitionEventCode,
    ...
    const nonSubjectCaseRecord = {
      ...caseRecord,
      docketEntries: [mockOrderForAmendedPetition],
      docketNumber: '999-99',
    };
    ...
    await fileAndServeCourtIssuedDocumentInteractor(applicationContext, {
      ...
      docketNumbers: [
        ...
        nonSubjectCaseRecord.docketNumber,
      ],
      form: mockOrderForAmendedPetitionForm,
      subjectCaseDocketNumber: caseRecord.docketNumber,
    });
