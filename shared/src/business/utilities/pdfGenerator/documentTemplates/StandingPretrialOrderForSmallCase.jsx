    ...
    <div className="standing-pretrial-order-small-case">
      ...
      <ol className="inline-ol">
        ...
        <li>
          ...
          website, <a href="https://www.ustaxcourt.gov">www.ustaxcourt.gov</a>.
        </li>

        <li>
          <span className="bu">Electronic Filing (eFiling)</span>. The Court
          encourages registration for DAWSON, the Court’s electronic filing and
          case management system, so that you can electronically file and view
          documents in your case. If you are not registered for eFiling, you
          must send the opposing party a copy of any document you file with the
          Court. To register for DAWSON, email{' '}
        ...
        <li>
          ...
          as early as possible if you require help with English. It is generally
          the responsibility of each petitioner to bring an interpreter. If you
          give advance notice, the Court may have one available.
        </li>

        <li>
          <span className="bu">Readiness for Trial and Participation</span>. If
          your case needs a trial, the parties must be ready for trial when
          scheduled by the Judge. If you need special help with scheduling your
          trial, call the Judge’s chambers (at the telephone number listed
          below) as early as possible and before the first day of the trial
          session. If you have not yet settled your case and you do not
          participate in conference calls and pretrial conferences, or appear at
          trial, the Judge may dismiss your case and enter a decision against
          you.{' '}
          <span className="text-bold">
        ...
        <li>
          <span className="bu">Relevant Deadlines</span>. The Court has adopted
          the deadlines outlined below to facilitate the resolution of cases and
          draws the parties’ attention to them.
        </li>
              ...
              <li>
                <p>
                  ...
                  <span className="text-normal">
                    ...
                    exceptional circumstances. See Rule 133, Tax Court Rules of
                    Practice and Procedure (available at{' '}
                    <a href="https://www.ustaxcourt.gov">www.ustaxcourt.gov</a>
                    ). Even joint Motions for Continuance are not automatically
                    granted.
                  </span>
                </p>
              </li>
              ...
              <li>
                <p>
                  ...
                  <span className="text-normal">
                    ...
                    appears that a trial is necessary, each party should file a
                    Pretrial Memorandum no later than 21 days before the first
                    day of the trial session. You can use the Pretrial
              ...
              <li>
                <p>
                  ...
                  <span className="text-normal">
                    ...
                    trial, or (3) agreed in writing to facts and documents, the
                    other party may file a Motion to Dismiss for Lack of
            ...
            <ol type="i">
              <li>
                <p>
                  ...
                  <span className="text-normal">
                    . The parties must file a Stipulation of Facts together with
                    all stipulated documents. Documents and pages should be
                    numbered for parties to easily identify documents and pages
                    within documents. The parties should agree in writing
                    (stipulate) before the trial begins as to all relevant facts
                    and documents that they do not dispute. Examples might
                    include tax returns for the years involved and the notice
                    issued by the IRS.
                  </span>
                </p>
              </li>
              <li>
                <p>
                  ...
                  <span className="text-normal">
                    ...
                    not in the Stipulation of Facts should be exchanged as
        ...
        <li>
          ...
          must be filed to inform the Court if the status of the case changes at
          any time before the trial date and after a Pretrial Memorandum, Motion
          to Dismiss for Lack of Prosecution, or Status Report is filed.
          Alternatively, if the case has settled, a Proposed Stipulated Decision
          may be filed.
        </li>
        ...
        <li>
          ...
          log on and test their connections at least 30 minutes before a remote
          proceeding is scheduled to begin.
        </li>

        <li>
          <span className="bu">Time of Trial</span>. All parties <b>must</b> be
          prepared for trial at any time during the trial session unless a
          ...
          Judge’s chambers to request a specific date and time for the trial. If
          practicable, the Court will attempt to accommodate the request,
          keeping in mind other scheduling requirements and the anticipated
          length of the session. The parties and any witnesses must be ready to
          participate at the time the trial starts. Testimony given by you or
          your witnesses during the trial is considered evidence.
        </li>
      </ol>
