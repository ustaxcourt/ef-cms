  ...
  return (
    <>
      ...
      <p className="text-bold">
        ...
        session. If this is your first time appearing before the U.S. Tax Court,
      ...
      <p>
        ...
        and view documents in your case. If you are not registered for eFiling,
        you must send the opposing party a copy of any document you file with
        the Court. To register for DAWSON, email{' '}
        <a href="mailto:dawson.support@ustaxcourt.gov">
          dawson.support@ustaxcourt.gov
        </a>
        . eFiling will remain available to parties during the trial session. For
      ...
      <p>
        ...
        the Judge know as early as possible if you require help with English. It
        is generally the responsibility of each petitioner to bring an
      ...
      <p>
        ...
        failure to comply with this or other Court Orders. See Rule 131(b), Tax
        Court Rules of Practice and Procedure (available at{' '}
        <a href="https://www.ustaxcourt.gov">www.ustaxcourt.gov</a>).{' '}
        <span className="text-bold">
        ...
        Any failures may also be considered in relation to sanctions against and
      ...
      <ol className="text-bold inline-ol">
        ...
        <li>
          <p>
            ...
            <span className="text-normal">
              ...
              eFiling or otherwise submit in paper) the expert report. An expert
              witness’s testimony may be excluded if the party fails to comply
              with this Order and Rule 143(g).
            </span>
          </p>
        </li>
        <li>
          <p>
            ...
            <span className="text-normal">
              The parties{' '}
              <span className="text-underline text-bold">must file</span> one of
            ...
            <li>
              <p>
                ...
                <span className="text-normal">
                  ...
                  Stipulated Decision must be electronically filed no later than
                  21 days before the first day of the trial session. If the
                  parties have reached a basis for settlement and need
                  additional time to file the Proposed Stipulated Decision, they
                  must file a joint Status Report including a summary of the
                  basis of settlement no later than 21 days before the first day
                  of the trial session. A Stipulation of Settled Issues should
                  be attached, if available. The Status Report must state the
                  reasons for delay in filing the Proposed Stipulated Decision.
                  The Court may issue an Order specifying the date by which the
                  Proposed Stipulated Decision will be due. If a basis for
                  settlement is reached after the trial session begins, the
                  Court will handle any required scheduling on the record.
                </span>
              </p>
            </li>
            <li>
              ...
              <ol className="text-bold" type="i">
                <li>
                  <p>
                    ...
                    <span className="text-normal">
                      . Witnesses must be identified in the pretrial memorandum
            ...
            <li>
              <p>
                ...
                <span className="text-normal">
                  ...
                  party should file a Motion to Dismiss for Lack of Prosecution
            ...
            <li>
              <p>
                ...
                <span className="text-normal">
                  ...
                  in the Stipulation of Facts must be exchanged with the
        ...
        <li>
          <p>
            ...
            <span className="text-normal">
              . A Status Report must be filed to inform the Court if the status
        ...
        <li>
          <p>
            ...
            <span className="text-normal">
              ...
              technology and internet resources to participate. The parties
              should log on and test their connections at least 30 minutes
              before a remote proceeding is scheduled to begin.
            </span>
          </p>
        </li>
        <li>
          <p>
            ...
            <span className="text-normal">
              ...
              set by the Court. After Pretrial Memoranda are filed, the Court
              may schedule a specific date and time for the trial. The parties
              may also jointly contact the Judge’s chambers to request a
              specific date and time for the trial. If practicable, the Court
              will attempt to accommodate the request, keeping in mind other
              scheduling requirements and the anticipated length of the session.
              Parties should jointly inform the Judge as early as possible if
              they expect trial to require 3 days or more.
            </span>
          </p>
        </li>
      </ol>
