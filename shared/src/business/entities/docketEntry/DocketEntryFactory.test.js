...
describe('DocketEntryFactory', () => {
  ...
  describe('partyPrimary', () => {
    ...
    it('should be not required when isAutoGenerated is true and partyPrimary is true', () => {
      rawEntity.isAutoGenerated = false;
      rawEntity.partyPrimary = true;
    ...
    it('should be not required when isAutoGenerated is true, partyPrimary is false, partySecondary is true', () => {
      rawEntity.isAutoGenerated = false;
    ...
    it('should be not required when isAutoGenerated is true, partyPrimary is false, partySecondary is false, and partyPrivatePractitioner is true', () => {
      rawEntity.isAutoGenerated = false;
      rawEntity.partyPrimary = false;
