...
describe('DocketEntry entity', () => {
  ...
  describe('getAutoGeneratedDeadlineDescription', () => {
    it('should return the status report description', () => {
      ...
      expect(doc.getAutoGeneratedDeadlineDescription()).toEqual(AUTO_GENERATED_STATUS_REPORT_ORDER_DESCRIPTIONS.statusReport);
    });
    it('should return the description based on eventcode', () => {
      ...
      expect(doc.getAutoGeneratedDeadlineDescription()).toEqual('Filing Fee Due');
    });
  });
