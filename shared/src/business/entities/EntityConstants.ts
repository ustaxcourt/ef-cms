...
export const TODAYS_ORDERS_SORTS = {
  ...
  DOCKET_NUMBER_ASC: 'DOCKET_NUMBER_ASC',
  DOCKET_NUMBER_DESC: 'DOCKET_NUMBER_DESC',
  DOCUMENT_TITLE_ASC: 'DOCUMENT_TITLE_ASC',
  DOCUMENT_TITLE_DESC: 'DOCUMENT_TITLE_DESC',
  CASE_CAPTION_ASC: 'CASE_CAPTION_ASC',
  CASE_CAPTION_DESC: 'CASE_CAPTION_DESC',
  JUDGE_NAME_ASC: 'JUDGE_NAME_ASC',
  JUDGE_NAME_DESC: 'JUDGE_NAME_DESC',
};
