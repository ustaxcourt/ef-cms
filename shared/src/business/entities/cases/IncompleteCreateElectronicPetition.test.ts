...
import { IncompleteCreateElectronicPetition } from './IncompleteCreateElectronicPetition';
import { applicationContext } from '../../test/createTestApplicationContext';

describe('IncompleteCreateElectronicPetition entity', () => {
  describe('isValid', () => {
    it('assigns a new irsNoticeDate if one is not passed in', () => {
      const incompleteCreateElectronicPetition =
        new IncompleteCreateElectronicPetition(
          {
      ...
      expect(
        incompleteCreateElectronicPetition.getFormattedValidationErrors(),
      ).toEqual(null);
    });
