...
/**
 * Returns the auto-generated deadline description for the docket entry
 *
 * @param {object} rawDocketEntry Docket entry object
 * @returns {String} the deadline description
 */
const autoGeneratedDeadlineDescription = rawDocketEntry => {
  return rawDocketEntry.deadlineDescription;
};
...
module.exports = {
  ...
  autoGeneratedDeadlineDescription,
