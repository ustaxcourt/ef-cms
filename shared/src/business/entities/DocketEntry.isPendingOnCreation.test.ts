...
describe('isPendingOnCreation', () => {
  ...
  it('respects any defined "pending" value', () => {
    ...
    const doc1 = new DocketEntry(raw1, { authorizedUser: undefined });
    expect(doc1.pending).toBeTruthy();

    const raw2 = { eventCode: 'FOO', pending: false };
    const doc2 = new DocketEntry(raw2, { authorizedUser: undefined });
  ...
  it('sets pending to true for known list of matching event codes', () => {
    ...
    const doc3 = new DocketEntry(raw3, { authorizedUser: undefined });
    ...
    const doc4 = new DocketEntry(raw4, { authorizedUser: undefined });
