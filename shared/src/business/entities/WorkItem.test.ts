...
describe('WorkItem', () => {
  describe('isValid', () => {
    ...
    it('should set properties on WorkItem that pertain to the Case when a Case entity is passed into the constructor', async () => {
      ...
      aValidWorkItem.caseStatus = 'This should be overwritten';
      aValidWorkItem.leadDocketNumber = 'This should be overwritten';
      aValidWorkItem.docketNumberWithSuffix = 'This should be overwritten';
      ...
      mockCase.leadDocketNumber = '123-23';
