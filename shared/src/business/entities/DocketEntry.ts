...
export class DocketEntry extends JoiValidationEntity {
  ...
  public isFiledAcrossConsolidatedCasesByExternalUser?: boolean;
  ...
  constructor(
    ...
    this.isFiledAcrossConsolidatedCasesByExternalUser =
      rawDocketEntry.isFiledAcrossConsolidatedCasesByExternalUser;
