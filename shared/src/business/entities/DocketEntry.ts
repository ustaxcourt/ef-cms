...
export class DocketEntry extends JoiValidationEntity {
  ...
  constructor(
    ...
    this.isStatusReport = this.draftOrderState.orderType === 'statusReport' || this.draftOrderState?.orderType === 'statusReportStipulatedDecision';
