...
export const ROLE_PERMISSIONS = {
  ...
  COLD_CASE_REPORT: 'COLD_CASE_REPORT',
  ...
  DOCKET_CLERK_REPORT: 'DOCKET_CLERK_REPORT',
  ...
  GET_ALL_CASE_DATA: 'GET_ALL_CASE_DATA',
  ...
  MOTION_ORDER_RESPONSE: 'MOTION_ORDER_RESPONSE',
  PAY_PETITION_FILING_FEE: 'PAY_PETITION_FILING_FEE',
  ...
  REMOVE_PETITIONER_EMAIL: 'REMOVE_PETITIONER_EMAIL',
  REMOVE_USER_PENDING_EMAIL: 'REMOVE_USER_PENDING_EMAIL',
  ...
  GRANT_DENY_MOTION: 'GRANT_DENY_MOTION',
...
const adcPermissions: RolePermission[] = [
  ...
  ROLE_PERMISSIONS.GRANT_DENY_MOTION,
];
...
const admissionsClerkPermissions: RolePermission[] = [
  ...
  ROLE_PERMISSIONS.REMOVE_PETITIONER_EMAIL,
];
...
const docketClerkPermissions: RolePermission[] = [
  ...
  ROLE_PERMISSIONS.UNSEAL_ADDRESS,
...
const petitionerPermissions: RolePermission[] = [
  ...
  ROLE_PERMISSIONS.VIEW_DOCUMENTS,
  ROLE_PERMISSIONS.VIEW_CONSOLIDATED_CASES_CARD,
  ROLE_PERMISSIONS.PAY_PETITION_FILING_FEE,
];
...
const zendeskPermissions: RolePermission[] = [
  ...
  ROLE_PERMISSIONS.REMOVE_USER_PENDING_EMAIL,
];
