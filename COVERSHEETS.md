...
Simultaneous - Party eFiles a simultaneous doc across a group, Docket QC's all filings at once, and the document will only have two coversheets, the original and the new appended one with the service stamp.

Party eFiles a doc across a group, Docket QC's all filings at once and edits metadata for all filings at once.
The document will only have two coversheets, the original and the new appended one with the service stamp.
