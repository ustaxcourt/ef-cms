...
- Look into ways to mitigate east-west issues (reading directly after a write)

- getBlockedCases, which used an opensearch query, was modified. We need to modify our getBlockedCasesForTrialLocation query accordingly. Look at staging as a reference.
  - Also, re-add return type in getBlockedCasesInteractor
