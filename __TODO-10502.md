...
- Case Statistic has fields that are missing in the DB table
- Removing (and, probably, adding) a consolidated case does not work
- Removing case from trial session
- Adding/Updating petitioner information seems to be working, but double-check implementation
- Updating petitioner counsel breaks (but persists) if case is not served
