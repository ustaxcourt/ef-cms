...
export function petitionerAttemptsToUploadCorruptPdfUpdated() {
  cy.get('[data-testid="file-a-petition"]').click();
  cy.get('[data-testid="go-to-step-1"]').click();
...
export function petitionerCreatesElectronicCaseWithSpouseUpdated(
  primaryFilerName = 'John',
...
export function petitionerCreatesElectronicCaseWithDeceasedSpouseUpdated(
  primaryFilerName = 'John',
  secondaryFilerName = 'Sally',
) {
  cy.get('[data-testid="file-a-petition"]').click();
