  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        ...
        "arn:aws:dynamodb::ACCOUNT_ID:global-table/efcms-themis",
        ...
        "arn:aws:dynamodb:us-east-1:ACCOUNT_ID:table/efcms-themis",
        ...
        "arn:aws:dynamodb:us-west-1:ACCOUNT_ID:table/efcms-themis",
      ]
    },
    {
      "Sid": "IamGranular",
