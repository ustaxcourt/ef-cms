  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        ...
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-dev-us-east-1-lambdaRole",
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-dev-us-west-1-lambdaRole",
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-prod-us-east-1-lambdaRole",
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-prod-us-west-1-lambdaRole",
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-stg-us-east-1-lambdaRole",
        "arn:aws:iam::ACCOUNT_ID:role/ef-cms-sections-stg-us-west-1-lambdaRole",
