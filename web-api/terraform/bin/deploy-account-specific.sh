...
[[ -n "$ES_LOGS_CLUSTER_ARN" ]] && export TF_VAR_es_logs_cluster_arn="$ES_LOGS_CLUSTER_ARN"
[[ -n "$ES_LOGS_CONSUMER_ACCOUNT_IDS" ]] && export TF_VAR_es_logs_consumer_account_ids="$ES_LOGS_CONSUMER_ACCOUNT_IDS"
[[ -n "$ES_LOGS_EBS_VOLUME_SIZE_GB" ]] && export TF_VAR_es_logs_ebs_volume_size_gb="$ES_LOGS_EBS_VOLUME_SIZE_GB"
[[ -n "$ES_LOGS_ENDPOINT" ]] && export TF_VAR_es_logs_cluster_endpoint="$ES_LOGS_ENDPOINT"
[[ -n "$ES_LOGS_ENGINE_VERSION" ]] && export TF_VAR_es_logs_engine_version="$ES_LOGS_ENGINE_VERSION"
export TF_VAR_es_logs_instance_count="$ES_LOGS_INSTANCE_COUNT"
[[ -n "$ES_LOGS_INSTANCE_TYPE" ]] && export TF_VAR_es_logs_instance_type="$ES_LOGS_INSTANCE_TYPE"
[[ -n "$LOG_GROUP_ENVIRONMENTS" ]] && export TF_VAR_log_group_environments="$LOG_GROUP_ENVIRONMENTS"
[[ -n "$LOG_SNAPSHOT_BUCKET_NAME" ]] && export TF_VAR_log_snapshot_bucket_name="$LOG_SNAPSHOT_BUCKET_NAME"
...
[[ -n "$NUM_DAYS_TO_KEEP_LOGS" ]] && export TF_VAR_number_of_days_to_keep_info_logs="$NUM_DAYS_TO_KEEP_LOGS"
