...
npx parcel build websockets.js cron.js streams.js log-forwarder.js cognito-authorizer.js cognito-triggers.js legacy-document-migration.js api-public.js api.js --target node --bundle-node-modules --no-minify
popd
