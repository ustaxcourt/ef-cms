...
resource "aws_s3_bucket_server_side_encryption_configuration" "api_lambdas_bucket_sse_east" {
...
resource "aws_s3_object" "amended-petition-form-bucket-object-east" {
  ...
  etag   = filemd5("${path.module}/../../../../shared/static/pdfs/amended-petition-form.pdf")
}
