...
resource "aws_ssm_parameter" "elasticsearch_alpha_endpoint_ssm" {
  #checkov:skip=CKV2_AWS_34:Parameter stores the OpenSearch domain endpoint URL only (e.g. search-efcms-xxx.es.amazonaws.com) — not a secret; discoverable via AWS APIs
