resource "aws_cognito_user_pool" "pool" {
  ...
  admin_create_user_config {
    ...
    invite_message_template {
      ...
      email_message = "Welcome to the U.S. Tax Court case management system. You are now able to log in to view and manage your cases.<br /><br /><b>Your username: </b>{username}<br /></br /><b>Temporary password: </b>{####}<br /><br /><br />For added security, please log in to the <a href='https://${var.dns_domain}/'>U.S. Tax Court site</a> to change your password."
    }
  }
