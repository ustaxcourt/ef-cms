...
import { PractitionerDocument, RawPractitionerDocument } from '@shared/business/entities/PractitionerDocument';
...
export const getPractitionerDocumentInteractor = async (
  ...
  let practitionerDocument: RawPractitionerDocument[] | RawPractitionerDocument =
