...
export const serveCourtIssuedDocument = async (
  ...
  // Upload stamped PDF to S3 BEFORE the transaction. The document must be available
  // before emails are sent (so parties can access the served document). If the upload
  ...
  await withTransaction(async () => {
    ...
    // is only committed if emails successfully queue.
