...
export async function createUserConfirmation(
  ...
  const emailBody = `<div>
    ...
    <div style="margin-top: 20px;">
      <span>IMPORTANT: If you are filing a petition electronically, you must complete the process of filing your petition no later than 11:59 pm Eastern time on the last date to file. Petitions received by the Court after this time may be untimely and your case may be dismissed.</span>
    </div>
    <div style="margin-top: 20px;">
