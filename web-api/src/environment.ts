...
export const environment = {
  ...
  opensearchQueueUrl: `https://sqs.${process.env.AWS_REGION}.amazonaws.com/${process.env.AWS_ACCOUNT_ID}/opensearch_worker_queue_${process.env.STAGE}_${process.env.CURRENT_COLOR}`,
