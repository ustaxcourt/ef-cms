...
export const practitionerOnCaseTableDefinition = {
  id: DEFAULT as string,
  userId: DEFAULT as string,
  docketNumber: DEFAULT as string,
};

export type PractitionerOnCaseTable = typeof practitionerOnCaseTableDefinition;

export const DW_PRACTITIONER_ON_CASE_COLUMNS = Object.keys(
  practitionerOnCaseTableDefinition,
) as Array<keyof PractitionerOnCaseTable>;
