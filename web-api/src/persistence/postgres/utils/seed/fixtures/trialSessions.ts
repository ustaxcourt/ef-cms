...
const todayTermYear = formatDateString(today, FORMATS.YEAR);
const thirtyDaysFromToday = calculateISODate({
  dateString: today,
  howMuch: 30,
  units: 'days',
});
...
export const trialSessions: RawTrialSession[] = [
  ...
  },
  {
    ...
    estimatedEndDate: thirtyDaysFromToday,
    maxCases: 125,
