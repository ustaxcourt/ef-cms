...
export const caseDeadlines: NewCaseDeadlineKysely[] = [
  {
    ...
    createdAt: calculateDate({ dateString: '2019-08-22T12:46:01.052Z' }),
    deadlineDate: calculateDate({ dateString: '2019-08-22T04:00:00.000Z' }),
  ...
  },
  {
    ...
    createdAt: calculateDate({ dateString: '2019-08-22T12:49:10.949Z' }),
    deadlineDate: calculateDate({ dateString: '2019-08-23T04:00:00.000Z' }),
  ...
  },
  {
    ...
    createdAt: calculateDate({ dateString: '2019-08-22T12:51:32.434Z' }),
    deadlineDate: calculateDate({ dateString: '2019-08-22T04:00:00.000Z' }),
  ...
  },
  {
    ...
    createdAt: calculateDate({ dateString: '2019-08-22T12:47:16.905Z' }),
    deadlineDate: calculateDate({ dateString: '2019-08-25T04:00:00.000Z' }),
  ...
  },
  {
    ...
    createdAt: calculateDate({ dateString: '2020-01-01T01:02:15.185-04:00' }),
    deadlineDate: calculateDate({
      dateString: '2020-01-24T00:00:00.000-05:00',
    }),
