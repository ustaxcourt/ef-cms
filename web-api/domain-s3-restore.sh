...
aws s3 sync "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-east-1" "s3://${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-east-1"
aws s3 sync "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-west-1" "s3://${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-west-1"
...
echo " => bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-east-1"
echo " => bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-west-1"