...
[ -z "${S3_BUCKET_SYNC_QUEUE_URL}" ] && echo "You must set S3_BUCKET_SYNC_QUEUE_URL as an environment variable" && exit 1
[ -z "${S3_BUCKET_SYNC_DL_QUEUE_URL}" ] && echo "You must set S3_BUCKET_SYNC_DL_QUEUE_URL as an environment variable" && exit 1

echo "Running terraform with the following environment configs:"
echo "  - ENVIRONMENT=${ENVIRONMENT}"
echo "  - ZONE_NAME=${ZONE_NAME}"
echo "  - S3_BUCKET_SYNC_QUEUE_URL=${S3_BUCKET_SYNC_QUEUE_URL}"
echo "  - S3_BUCKET_SYNC_DL_QUEUE_URL=${S3_BUCKET_SYNC_DL_QUEUE_URL}"
