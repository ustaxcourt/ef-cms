...
const { up } = require('./00017-practitioners');

describe('practitioners refactoring migration', () => {
  ...
  it('should make put requests for each practitioner item of the case', async () => {
    scanStub = jest.fn().mockReturnValue({
      promise: jest.fn().mockResolvedValue({
        Items: [
          {
