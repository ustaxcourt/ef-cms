...
aws s3 mb "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-east-1" --region us-east-1
aws s3 mb "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-west-1" --region us-west-1
...
aws s3 sync "s3://${ZONE_NAME}-quarantine-documents-${ENV}-us-east-1" "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-east-1" 
aws s3 sync "s3://${ZONE_NAME}-quarantine-documents-${ENV}-us-west-1" "s3://bck-${EFCMS_DOMAIN}-quarantine-documents-${ENV}-us-west-1" 
...
echo "=> ${ZONE_NAME}-quarantine-documents-${ENV}-us-east-1"
echo "=> ${ZONE_NAME}-quarantine-documents-${ENV}-us-west-1"