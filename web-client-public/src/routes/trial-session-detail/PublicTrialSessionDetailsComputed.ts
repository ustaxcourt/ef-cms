...
export const publicTrialSessionDetailsComputed = ({
  trialSession,
}: {
  ...
  const formattedStartDate = formatDateString(trialSession.startDate, 'MMDDYY');

  const formattedStartDateFull = formatDateString(trialSession.startDate, 'MONTH_DAY_YEAR');
