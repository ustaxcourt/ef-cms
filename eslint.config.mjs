...
jsxA11y.flatConfigs.recommended, // This config ignores formatting rules in the linter. Linters are not formatters.
prettierConfig, // cypress recommendations
pluginCypress.configs.recommended, tseslint.configs.recommendedTypeChecked, {
