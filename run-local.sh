...
npx ts-node --transpile-only web-api/streams-local.js &
npx ts-node --transpile-only web-api/websockets-local.js &
npx ts-node --transpile-only web-api/src/app-local.js &
npx ts-node --transpile-only web-api/src/app-public-local.js
