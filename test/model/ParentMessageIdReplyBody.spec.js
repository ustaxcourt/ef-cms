...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParentMessageIdReplyBody', function() {
      beforeEach(function() {
        instance = new DevEfCms.ParentMessageIdReplyBody();
      });

      it('should create an instance of ParentMessageIdReplyBody', function() {
        // TODO: update the code to test ParentMessageIdReplyBody
        expect(instance).to.be.a(DevEfCms.ParentMessageIdReplyBody);
      });
