...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnprocessableEntityError', function() {
      beforeEach(function() {
        instance = new DevEfCms.UnprocessableEntityError();
      });

      it('should create an instance of UnprocessableEntityError', function() {
        // TODO: update the code to test UnprocessableEntityError
        expect(instance).to.be.a(DevEfCms.UnprocessableEntityError);
      });
