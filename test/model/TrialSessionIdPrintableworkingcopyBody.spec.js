...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrialSessionIdPrintableworkingcopyBody', function() {
      beforeEach(function() {
        instance = new DevEfCms.TrialSessionIdPrintableworkingcopyBody();
      });

      it('should create an instance of TrialSessionIdPrintableworkingcopyBody', function() {
        // TODO: update the code to test TrialSessionIdPrintableworkingcopyBody
        expect(instance).to.be.a(DevEfCms.TrialSessionIdPrintableworkingcopyBody);
      });
