...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParentMessageIdForwardBody1', function() {
      beforeEach(function() {
        instance = new DevEfCms.ParentMessageIdForwardBody1();
      });

      it('should create an instance of ParentMessageIdForwardBody1', function() {
        // TODO: update the code to test ParentMessageIdForwardBody1
        expect(instance).to.be.a(DevEfCms.ParentMessageIdForwardBody1);
      });
