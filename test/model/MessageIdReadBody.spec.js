...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageIdReadBody', function() {
      beforeEach(function() {
        instance = new DevEfCms.MessageIdReadBody();
      });

      it('should create an instance of MessageIdReadBody', function() {
        // TODO: update the code to test MessageIdReadBody
        expect(instance).to.be.a(DevEfCms.MessageIdReadBody);
      });
