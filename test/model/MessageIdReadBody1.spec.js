...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageIdReadBody1', function() {
      beforeEach(function() {
        instance = new DevEfCms.MessageIdReadBody1();
      });

      it('should create an instance of MessageIdReadBody1', function() {
        // TODO: update the code to test MessageIdReadBody1
        expect(instance).to.be.a(DevEfCms.MessageIdReadBody1);
      });
