...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParentMessageIdReplyBody1', function() {
      beforeEach(function() {
        instance = new DevEfCms.ParentMessageIdReplyBody1();
      });

      it('should create an instance of ParentMessageIdReplyBody1', function() {
        // TODO: update the code to test ParentMessageIdReplyBody1
        expect(instance).to.be.a(DevEfCms.ParentMessageIdReplyBody1);
      });
