...
COGNITO_REDIRECT_URL="https%3A//ui-${ENV}.${EFCMS_DOMAIN}"
COGNITO_REDIRECT_URI="https://ui-${ENV}.${EFCMS_DOMAIN}"
...
SESSION_TIMEOUT=3300000 COGNITO_CLIENT_ID="${CLIENT_ID}" COGNITO_TOKEN_URL="${COGNITO_TOKEN_URL}" COGNITO_REDIRECT_URI="${COGNITO_REDIRECT_URI}" API_URL="${API_URL}" COGNITO_LOGIN_URL="${COGNITO_LOGIN_URL}" npm run dist