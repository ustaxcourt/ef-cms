...
describe('private practitioner views pending email journey', () => {
  ...
  // log in as admissionsclerk
  //associate a practitioner to the case
  // add a new email for that practitioner
  // store pending email on test.something maybe???

  //login as a DIFFERENT private practitioner (2)
