...
import { setAsyncTokenSequence } from '@web-client/presenter/sequences/setAsyncTokenSequence';
...
export const presenterSequences = {
  ...
  setAsyncTokenSequence: setAsyncTokenSequence as unknown as Function,
