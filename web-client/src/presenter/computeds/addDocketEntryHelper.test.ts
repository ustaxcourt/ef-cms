...
describe('addDocketEntryHelper', () => {
  ...
  it('uses multiDocketedOriginalCaseDetail when set', () => {
    const mockMultiDocketedState = {
      caseDetail: { ...MOCK_CASE, isPaper: true },
      form: {
        eventCode: undefined as undefined | string,
        documentType: undefined as undefined | string,
        scenario: undefined as undefined | string,
      ...
      multiDocketedOriginalCaseDetail: { ...MOCK_CASE, isPaper: false },
      validationErrors: {},
    };

    const result = runCompute(addDocketEntryHelper, {
      state: mockMultiDocketedState,
    });
