...
describe('case detail computed', () => {
  ...
  describe('trialSessionsFormatted', () => {
    const trialSessions = [
      {
        sessionType: 'Regular',
    ...
    it('should not return trialSessionsFormatted if modal state does not contain trialSessions', () => {
      const result = runCompute(caseDetailHelper, {
        state: {
          caseDetail: {},
          form: {},
    ...
    it('should filter out trial sessions that do not have the status Upcoming', () => {
      ...
      expect(result.trialSessionsFormatted.length).toEqual(
    ...
    it('should not filter trialSessions by preferredTrialCity if state.modal.showAllLocations is true', () => {
      const result = runCompute(caseDetailHelper, {
        state: {
          caseDetail: { preferredTrialCity: 'Birmingham, Alabama' },
          form: {},
    ...
    it('should format optionText for each trial session and sort by location and then by date when showAllLocations is true', () => {
      const result = runCompute(caseDetailHelper, {
        state: {
          caseDetail: { preferredTrialCity: 'Birmingham, Alabama' },
          form: {},
