...
import { editPractitionerContactHelper as editPractitionerContactHelperComputed } from './editPractitionerContactHelper';
import { runCompute } from 'cerebral/test';
import { withAppContextDecorator } from '../../withAppContext';

const editPractitionerContactHelper = withAppContextDecorator(
  editPractitionerContactHelperComputed,
  applicationContext,
);

describe('editPractitionerContactHelper', () => {
  it('should validate form view information for party type Conservator', () => {
    const result = runCompute(editPractitionerContactHelper, {
      state: {
        constants: {
