...
import { representAPartyHelper as representAPartyHelperComputed } from './representAPartyHelper';
import { runCompute } from '@web-client/presenter/test.cerebral';
import { withAppContextDecorator } from '../../withAppContext';

describe('representAPartyHelper', () => {
  ...
  const representAPartyHelper = withAppContextDecorator(
    representAPartyHelperComputed,
    applicationContext,
  );
  ...
  it('returns correct values when documentType is undefined', () => {
    ...
    const result = runCompute(representAPartyHelper, {
      state: testState,
    });
  ...
  it('indicates file uploads are valid', () => {
    ...
    const result = runCompute(representAPartyHelper, { state });
  ...
  it('shows filing includes if certificate of service or attachments is true', () => {
    ...
    let result = runCompute(representAPartyHelper, { state });
    ...
    result = runCompute(representAPartyHelper, { state });
    expect(result.showFilingIncludes).toEqual(true);
  });
  ...
  describe('showGenerationTypeForm', () => {
    ...
    it('should set showGenerationTypeForm to true when code is EA and no petitioner has paper and user is a irsPractitioner', () => {
      ...
      const { showGenerationTypeForm } = runCompute(representAPartyHelper, {
        state,
      });
  ...
  describe('representingPartiesNames', () => {
    ...
    it('should be set to the names of all petitioners being represented', () => {
      const { representingPartiesNames } = runCompute(representAPartyHelper, {
        state,
      });
