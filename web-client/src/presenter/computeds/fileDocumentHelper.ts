...
export const fileDocumentHelper = (
  ...
  // TODO, if "showPartiesFiling" is false, we should auto-set the filing party to respondent.
  const showPartiesFiling = !isFirstIrsFiling(applicationContext, caseDetail);
