...
describe('generateDocketRecordPdfUrlAction', () => {
  let generateDocketRecordPdfInteractor;
  beforeEach(() => {
    const applicationContext = applicationContextForClient;
    presenter.providers.applicationContext = applicationContext;
    generateDocketRecordPdfInteractor = applicationContext.getUseCases()
  ...
  it('creates a pdf and returns an object URL', async () => {
    ...
    expect(generateDocketRecordPdfInteractor).toHaveBeenCalled();
