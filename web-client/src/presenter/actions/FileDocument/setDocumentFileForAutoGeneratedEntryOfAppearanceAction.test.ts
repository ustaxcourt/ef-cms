...
describe('setDefaultFileDocumentFormValuesAction', () => {
  it('should not change the primaryDocumentFile if the pdfPreviewUrl is not set', async () => {
  ...
  it('should modify the primaryDocumentFile when the pdfPreviewUrl is set', async () => {
    (global as any).fetch = async () => {
      return {
        blob: async () => {
          return new Blob([], { type: 'pdf' });
        },
      };
    };
