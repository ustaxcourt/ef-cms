...
describe('getDocketNumbersForConsolidatedServiceAction', () => {
  ...
  it('should return the checked member case docket numbers for a multi-docketable docket entry', async () => {
    const { output } = await runAction(
      getDocketNumbersForConsolidatedServiceAction,
      {
        modules: {
  ...
  it('should return an empty list when the docket entry is multi-docketable but modal.form.consolidatedCasesToMultiDocketOn is undefined', async () => {
    const { output } = await runAction(
      getDocketNumbersForConsolidatedServiceAction,
      {
        modules: {
