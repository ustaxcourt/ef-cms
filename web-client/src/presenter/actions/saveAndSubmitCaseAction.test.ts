...
describe('saveAndSubmitCaseAction', () => {
  ...
  it('should generate document Ids, create case, and call success path for a user uploaded petition', async () => {
  ...
  it('should generate document Ids, create case, and call success path for a generated petition', async () => {
    docketEntries.push({ docketEntryId: '1', isFileAttached: true });
    docketEntries.push({ docketEntryId: '2', isFileAttached: true });
    docketEntries.push({ docketEntryId: '3', isFileAttached: false });
