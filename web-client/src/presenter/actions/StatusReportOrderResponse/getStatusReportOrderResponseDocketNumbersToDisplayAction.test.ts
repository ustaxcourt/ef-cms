...
import { getStatusReportOrderResponseDocketNumbersToDisplayAction } from './getStatusReportOrderResponseDocketNumbersToDisplayAction';
import { presenter } from '@web-client/presenter/presenter-mock';
import { runAction } from '@web-client/presenter/test.cerebral';

describe('getStatusReportOrderResponseDocketNumbersToDisplayAction,', () => {
  beforeAll(() => {
  ...
  it("should use the case's docket number as the docket number to display when the case is not a lead case", async () => {
    ...
    expect(
      result.state.statusReportOrderResponse.docketNumbersToDisplay,
