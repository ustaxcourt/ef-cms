...
describe('prepareStatusReportOrderAction,', () => {
  ...
  const expectedFiledLine = `<p class="indent-paragraph">On ${statusReportFilingDateFormatted}, a status report was filed (doc. no. ${statusReportIndex}). For cause, it is</p>`;
  ...
  it.each([
    [
      ...
      `<p class="indent-paragraph">On ${statusReportFilingDateFormatted}, a status report was filed (lead case doc. no. ${statusReportIndex}). For cause, it is</p>`,
    ],
    [
      STATUS_REPORT_ORDER_OPTIONS.issueOrderOptions.justThisCase,
      `<p class="indent-paragraph">On ${statusReportFilingDateFormatted}, a status report was filed (doc. no. 4). For cause, it is</p>`,
    ],
  ])(
