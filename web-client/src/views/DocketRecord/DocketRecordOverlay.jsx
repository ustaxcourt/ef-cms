...
import { DocketRecordOverlay as DocketRecordOverlayOld } from './DocketRecord.old';
...
export const DocketRecordOverlay = isCodeEnabled(7199)
  ? connect(
      {
