...
type ServeCaseToIrsDuplicateErrorModalProps = {
  onCancelSequence?: string;
  onConfirmSequence?: string;
};

export const ServeCaseToIrsDuplicateErrorModal: React.FC<ServeCaseToIrsDuplicateErrorModalProps> =
  connect(
    {
