...
export const WhatToExpect = () => (
  <>
    ...
    Revenue Service (IRS) — you’ll be asked to upload some forms you can prepare
    in advance.
    <div className="icon-list">
      <div className="icon-item">
        ...
        <span className="description-wrapper">
          Here are the forms you can fill out before you get started:
          <p className="label">
            1. Statement of Taxpayer Identification Number (STIN)
          </p>
          This is used to help the IRS identify who you are. Everyone will need
          to upload this to create a case.
          <br />
          <Button
            link
          ...
          court additional information about ownership interests in the
          business.
          <br />
          <Button
            link
