...
export const SignOrderFactory = ({ skipSequence, submitSequence }) =>
  connect(
    {
      ...
      saveDocumentSigningSequence: sequences[submitSequence],
      ...
      skipSigningOrderSequence: sequences[skipSequence],
    },
    function SignOrderFactory({
      currentPageNumber,
      docketNumber,
      documentId,
      pdfForSigning,
