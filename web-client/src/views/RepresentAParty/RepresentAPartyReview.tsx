...
export const RepresentAPartyReview = connect(
  {
  ...
  function RepresentAPartyReview({
    fileDocumentHelper,
    form,
              ...
              <div className="grid-row grid-gap">
                <div
                  className={classNames('margin-bottom-4', {
                    'grid-col-12':
                      representAPartyHelper.isAutoGeneratedEntryOfAppearance,
                    'tablet:grid-col-7':
                      !representAPartyHelper.isAutoGeneratedEntryOfAppearance,
                  })}
                >
                  <div className="card height-full margin-bottom-0">
                    <div className="content-wrapper">
                      ...
                      <div className="grid-row grid-gap">
                        ...
                        {!representAPartyHelper.isAutoGeneratedEntryOfAppearance && (
                          <div className="tablet:grid-col margin-bottom-1">
                            {representAPartyHelper.showFilingIncludes && (
                              <div
                                ...
                                <ul className="ustc-unstyled-list without-margins">
                                  {form.certificateOfService && (
                                    <li>
                                      ...
                                      {
                                        representAPartyHelper.certificateOfServiceDateFormatted
                                      }
                                    </li>
                                  )}
                      ...
                      <div className="content-wrapper">
                        ...
                        <div className="grid-row grid-gap">
                          <div className="tablet:grid-col-6 margin-bottom-1">
                            ...
                            <ul className="ustc-unstyled-list without-margins">
                              {representAPartyHelper.representingPartiesNames.map(
                                name => (
                                  <li key={name}>{name}</li>
                                ),
                              )}
...
RepresentAPartyReview.displayName = 'RepresentAPartyReview';
