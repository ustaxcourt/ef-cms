...
export const CaseSearchByDocketNumber: React.FC<CaseSearchByDocketNumberProps> =
  connect(
    {
      advancedSearchForm: state.advancedSearchForm,
      clearAdvancedSearchFormSequence:
        sequences.clearAdvancedSearchFormSequence,
    ...
    function CaseSearchByDocketNumber({
      ...
      advancedSearchForm: {
        caseSearchByDocketNumber: { docketNumber?: string };
      };
