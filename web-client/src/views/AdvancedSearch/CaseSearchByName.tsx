...
// Define the props interface for the pure component
interface CaseSearchByNameProps {
  readonly advancedSearchForm: any;
  readonly advancedSearchHelper: any;
  readonly caseSearchByNameHelper: any;
  readonly clearAdvancedSearchFormSequence: (params: {
    formType: string;
  }) => void;
  readonly submitAdvancedSearchSequence: () => void;
  readonly updateAdvancedSearchFormValueSequence: (params: {
    formType: string;
    key: string;
    value: string;
  }) => void;
  readonly updateCaseAdvancedSearchByNameFormValueSequence: (params: {
    key: string;
    value: string;
  }) => void;
  readonly usStates: any;
  readonly usStatesOther: any;
  readonly validateCaseAdvancedSearchFormSequence: () => void;
  readonly validationErrors: any;
}

// Pure component - no Cerebral dependencies
export function CaseSearchByNameComponent({
  advancedSearchForm,
            ...
            <div className="tablet:grid-col-12">
              <FormGroup errorText={validationErrors.petitionerName}>
                ...
                <span className="usa-hint">
                  Advanced syntax search (*, “”, - , etc. ) is not supported at
                  this time.
                </span>
                <input
