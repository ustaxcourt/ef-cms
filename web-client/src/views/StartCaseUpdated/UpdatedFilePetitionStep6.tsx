      ...
      <>
        ...
        <div className="grid-row grid-gap">
          <div className="grid-col">
            ...
            />
            <div
              className={classNames('grid-container padding-x-0', {
                'grid-auto-generated': isAutoGenerated,
              })}
            >
              <div className="grid-row grid-gap">
                <div
                  className={classNames('margin-bottom-4', {
                    'grid-col-4': !isAutoGenerated,
                    'grid-col-12': isAutoGenerated,
