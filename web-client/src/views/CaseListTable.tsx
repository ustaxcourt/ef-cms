...
export const CaseListTable = connect(
  {
  caseType: (state as any).openClosedCases.caseType,
  ...
  showMoreResultsSequence: (...args: any[]) => any;
      tabName: string;
      isMobile: boolean;
    }) => {
      return (
                ...
                >
                  ...
                  >
                    {renderCaseListTable({
                      ...
                      showMoreResultsSequence: (showMoreOpenCasesSequence as any),
                      tabName: openTab,
                    })}
                  </Tab>
                  <Tab
                  ...
                  >
                    {renderCaseListTable({
                      ...
                      showMoreResultsSequence: (showMoreClosedCasesSequence as any),
                      tabName: closedTab,
                    })}
                  </Tab>
