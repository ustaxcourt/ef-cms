      ...
      >
        <div className="margin-bottom-1">
          <div className="grid-row margin-bottom-05">
            ...
            <div className="grid-col-fill" data-testid="seal-address-modal-address-1">{contactToSeal.address1}</div>
          </div>
          {contactToSeal.address2 && (
            <div className="grid-row margin-bottom-05">
              <div className="grid-col-4"></div>
              <div className="grid-col-fill" data-testid="seal-address-modal-address-2">{contactToSeal.address2}</div>
            </div>
          )}
          {contactToSeal.address3 && (
            <div className="grid-row margin-bottom-05">
              <div className="grid-col-4"></div>
              <div className="grid-col-fill" data-testid="seal-address-modal-address-3">{contactToSeal.address3}</div>
            </div>
          )}
          <div className="grid-row">
            <div className="grid-col-4"></div>
            <div className="grid-col-fill">
              <span className="no-wrap" data-testid="seal-address-modal-address-city-state-zip">
        ...
        <div className="grid-row margin-bottom-1">
          ...
          <div className="grid-col-fill">
            <span className="no-wrap" data-testid="seal-address-modal-phone">{contactToSeal.phone}</span>
          </div>
        </div>
        <div className="grid-row margin-bottom-1">
          ...
          <div className="grid-col-fill">
            <span className="no-wrap" data-testid="seal-address-modal-email">
              {contactToSeal.email ?? 'Not Provided'}
            </span>
          </div>
        </div>
        <div className="grid-row margin-bottom-1">
          ...
          <div className="grid-col-fill">
            <span className="no-wrap" data-testid="seal-address-modal-address-petition-email">
              {contactToSeal.paperPetitionEmail ?? 'Not Provided'}
            </span>
          </div>
        </div>
      </ConfirmModal>
