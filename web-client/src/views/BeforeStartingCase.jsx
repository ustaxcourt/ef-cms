          ...
          <div role="listitem">
            ...
            <div className="before-explanation">
              ...
              <p>
                ...
                or Notice of Determination, you’ll need to include a copy with
                your Petition. The U.S. Tax Court must receive all Petitions in
                a timely manner. The IRS notice shows the last date to file or
                the number of days you have to file a Petition.{' '}
                <strong>
          ...
          <div role="listitem" className="margin-bottom-0">
            ...
            <div className="before-explanation">
              ...
              <p>
                ...
                Security Number (SSN), Taxpayer Identification Number (TIN), or
                Employer Identification Number (EIN). This document is sent to
                the IRS to help identify you, but it’s never viewed by the Court
                or stored as part of the public record.
              </p>
          ...
          <div role="listitem">
            ...
            <div className="before-explanation">
              ...
              <p>
                ...
                Identification Numbers), remove or redact that information
                before including it with your Petition. You can remove this
                information by deleting it, marking through it so itʼs
                illegible, or any other method that will prevent it from being
                seen.
              </p>
            </div>
          </div>
          ...
          <div role="listitem">
            ...
            <div className="before-explanation">
              ...
              <p>
                ...
                to start your case. Uploads are limited to {MAX_FILE_SIZE_MB}MB.{' '}
                <a
                  href={howToMergePDFs}
                  target="_blank"
                  rel="noopener noreferrer"
