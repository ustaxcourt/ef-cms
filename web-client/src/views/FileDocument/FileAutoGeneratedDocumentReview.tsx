...
export const FileAutoGeneratedDocumentReview = connect(
  {
    fileAutoGeneratedDocumentReviewHelper:
      state.fileAutoGeneratedDocumentReviewHelper,
        ...
        <div className="grid-row grid-gap">
                  ...
                  <div className="card height-full margin-bottom-0">
                    <div className="content-wrapper">
                      <h3 className="underlined">
                        {
                          fileAutoGeneratedDocumentReviewHelper.partiesHeaderText
                        }
                      </h3>
                      <div className="grid-row grid-gap">
                        <div className="tablet:grid-col-12 margin-bottom-1">
                          <h3 className="usa-label">
                            {
                              fileAutoGeneratedDocumentReviewHelper.partiesLabelText
                            }
                          </h3>
                          <ul
                            className="ustc-unstyled-list without-margins"
                            data-testid="auto-generated-parties"
                          >
                            {fileAutoGeneratedDocumentReviewHelper.formattedParties.map(
                              party => (
                                <li data-testid={`party-${party}`} key={party}>
                                  {party}
                                </li>
                              ),
                            )}
              ...
              <div className="tablet:grid-col-12 bg-white submit-reminders">
                ...
                <div className="margin-top-4 button-container">
                  <Button
                    ...
                    data-testid="submit-auto-generated-document-button"
                    id="submit-document"
                    type="submit"
                    onClick={() => {
                      onSubmit();
          ...
          <NonMobile>
            <div
              ...
              data-testid="auto-generated-pdf-preview"
            >
