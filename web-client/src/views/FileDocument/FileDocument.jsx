...
export const FileDocument = connect(
  ...
  ({ form, chooseWizardStepSequence, constants, updateFormValueSequence }) => {
    return (
      <React.Fragment>
            ...
            <div className="usa-width-five-twelfths">
                    ...
                    {['Yes', 'No'].map(option => (
                      <li key={option}>
                        <input
                          ...
                          value={form.certificateOfService}
                          onChange={e => {
                            updateFormValueSequence({
                              key: e.target.name,
              ...
              <div className="ustc-form-group">
                ...
                >
                  ...
                  {constants.CATEGORY_MAP['Supporting Document'].map(entry => {
                    return (
                      <option
        ...
        <h3>Tell Us About the [Secondary Document]</h3>
        <div className="blue-container">
          <div className="usa-grid-full">
            <div className="usa-width-seven-twelfths push-right">
              <div id="document-upload-hint" className="alert-gold">
                    ...
                    {['Yes', 'No'].map(option => (
                      <li key={option}>
                        <input
                          ...
                          value={form.secondarySupportingDocuments}
                          onChange={e => {
                            updateFormValueSequence({
                              key: e.target.name,
                              value: e.target.value,
            ...
            <ul className="ustc-vertical-option-list">
              <li>
                <input
                  ...
                  value="Myself"
                />
                <label htmlFor="parties-1">Myself</label>
              </li>
              <li>
                <input
                  id="parties-2"
                  ...
                  value="Myself"
                />
                <label htmlFor="parties-2">[Secondary Contact Name]</label>
              </li>
              <li>
                <input
                  id="parties-3"
                  ...
                  value="Myself"
                />
                <label htmlFor="parties-3">[Respondent]</label>
              </li>
            </ul>
          </fieldset>
        </div>
