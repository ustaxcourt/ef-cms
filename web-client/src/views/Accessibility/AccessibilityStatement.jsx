...
export const AccessibilityStatement = () => (
  <div className="grid-container">
    ...
    <p>
      ...
      limitations, and potential solutions. Please contact us if you observe an
    ...
    <ol className="technical-information accessibility-limitations">
      <li>
        ...
        : Some documents may or may not have accessible content via screenreader
        applications. because Some documents may have been scanned without the
        benefit of optical character recognition (OCR) due to the quality of the
        original document.
      </li>
    </ol>
    ...
    <ul className="technical-information assessment-approaches">
      ...
      <li>
        ...
        software libraries : <a href="https://pa11y.org/">https://pa11y.org/</a>
      </li>
    </ul>
