...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'tw:rounded-lg tw:border tw:shadow-sm tw:p-3 tw:[--cell-size:2rem] tw:bg-white tw:[&_.rdp-week]:hover:bg-transparent tw:[&_.rdp-week]:hover:shadow-none tw:[&_.rdp-weekdays]:hover:bg-transparent tw:[&_.rdp-weekday]:hover:bg-transparent tw:[&_.rdp-month]:hover:bg-transparent tw:[&_.rdp-months]:hover:bg-transparent tw:[&_.rdp-table]:hover:bg-transparent tw:[&_.rdp-tbody]:hover:bg-transparent tw:[&_.rdp-thead]:hover:bg-transparent tw:[&_thead]:hover:bg-transparent tw:[&_thead]:hover:shadow-none tw:[&_thead]:hover:border-none tw:[&_thead]:hover:outline-none tw:[&_thead]:hover:ring-0 tw:[&_thead]:hover:ring-offset-0 tw:[&_thead]:hover:ring-inset-0 tw:[&_thead]:hover:ring-opacity-0 tw:[&_tr]:hover:shadow-none tw:[&_tr]:hover:box-shadow-none tw:[&_tr]:hover:!shadow-none tw:[&_tr]:hover:!box-shadow-none tw:[&_tr]:min-h-0',
