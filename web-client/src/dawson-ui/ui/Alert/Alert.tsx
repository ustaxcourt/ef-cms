    ...
    <div className="tw:flex tw:xs:!h-[24px]">
      <div className="tw:xs:text-2xl/6 tw:!h-[20px] tw:!w-[20px] tw:xs:!h-[24px] tw:xs:!w-[24px]">
        <FontAwesomeIcon
          ...
          className="tw:!0h-[20px] tw:!w-[20px] tw:xs:!h-[24px] tw:xs:!w-[24px]"
        />
      </div>
      <div
        className={cn(
          title
            ? 'tw:font-bold tw:text-base tw:xs:text-lg/6'
            : 'tw:text-base',
          'tw:pb-0 tw:xs:ml-3',
        )}
      ...
      {isDismissible && (
        ...
        >
          <div className="tw:flex tw:text-sm tw:xs:text-base/4 tw:hover:text-primary-dark tw:active:text-primary-darker tw:active:fill-primary-darker tw:hover:fill-primary-dark">
            ...
            <CircleXmark className="tw:!h-[14px] tw:!w-[14px] tw:xs:!h-[16px] tw:xs:!w-[16px] tw:xs:mt-0.5 tw:xs:mb-0.5" />
          </div>
        </Button>
      )}
    </div>
