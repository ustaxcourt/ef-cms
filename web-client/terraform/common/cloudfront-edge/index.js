  ...
  headers['content-security-policy'] = [
    {
      ...
      value: `default-src 'self'; connect-src https://${allowedDomainString} https://*.auth.us-east-1.amazoncognito.com; img-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; object-src 'none'`,
    },
  ];
