...
module "ui-certificate" {
  ...
  domain_name      = "app-${var.current_color}.${var.dns_domain}"
  hosted_zone_name = "${var.zone_name}."
  certificate_name = "app-${var.current_color}.${var.dns_domain}"
  environment      = var.environment
  description      = "Certificate for app-${var.current_color}.${var.dns_domain}"
