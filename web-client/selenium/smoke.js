module.exports = {
  'Log In': function(browser) {
    browser
      .url(
        'https://auth-dev-flexion-efcms.auth.us-east-1.amazoncognito.com/login?response_type=code&client_id=6tu6j1stv5ugcut7dqsqdurn8q&redirect_uri=https%3A//ui-dev.ustc-case-mgmt.flexion.us/log-in',
      )
