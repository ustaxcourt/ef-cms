...
module.exports = [
  ...
  },
  {
    actions: [
      ...
      'click element label#country-radio-label-international',
      'wait for input#contactPrimary.country to be visible',
      'wait for input#contactSecondary-countryType-domestic to be visible',
      'click element label#country-radio-label-international',
      'wait for input#contactSecondary.country to be visible',
    ],
    notes: [
