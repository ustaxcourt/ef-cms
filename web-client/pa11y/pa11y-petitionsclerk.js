module.exports = [
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/',
  /* start case internal */
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/file-a-petition/step-1',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/file-a-petition/step-1&info=secondary-contact',
  },
  {
    actions: [
      'wait for #party-type to be visible',
      ...
      'check field #party-type',
      'wait for #order-for-cds to be visible',
    ],
  ...
  },
  {
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/file-a-petition/step-1&info=case-info-tab',
  },
  {
    actions: [
  ...
  /* case detail */
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/108-19&info=case-information-tab-overview',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/102-19&info=case-information-tab-parties',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/999-15&info=case-information-tab-parties-repondent',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/102-19&info=add-practitioner-modal',
  },
  {
    actions: ['wait for #practitioner-representing to be visible'],
    notes: 'checks a11y of edit petitioner counsel page',
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-19/edit-petitioner-counsel/PT1234',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/102-19&info=add-respondent-modal',
  },
  {
    actions: ['wait for #submit-edit-respondent-information to be visible'],
    notes: 'checks a11y of edit respondentCounsel page',
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/103-19/edit-respondent-counsel/RT6789',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/109-19&info=edit-signed-order-confirm-modal/',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-19&info=create-message-modal',
  },
  {
    actions: [
      'wait for #case-detail-menu-button to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-19&info=create-order-modal',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/107-19&info=tracked-items-tab',
  },
  {
    actions: [
      'wait for #case-detail-menu-button to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-19&info=add-deadline',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/109-19&info=case-information-tab-blocked',
  },
  {
    actions: [
      'wait for #tab-drafts to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/109-19&info=drafts-tab',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/109-19&info=case-messages-tab',
  },
  {
    actions: [
      'wait for #tab-tracked-items to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/109-19&info=tracked-items-tab-pending-report',
  },
  {
    actions: [
  ...
  },
  {
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/103-19/upload-correspondence&info=add-correspondence',
  },
  {
    actions: [
      'wait for #tab-correspondence to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/103-19&info=edit-correspondence',
  },
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/103-20/document-view?docketEntryId=ac62f25a-49f9-46a5-aed7-d6b955a2dc34&info=document-view-review-and-serve-petition-button',
  {
    actions: [
      'wait for #tab-case-information to be visible',
      'click element #tab-case-information',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/108-19&info=add-edit-calendar-note-modal',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/108-19&info=remove-case-from-session-modal',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19&info=prioritize-case-modal',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/110-19&info=unprioritize-case-modal',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/104-19&info=add-case-to-session-modal',
  },
  {
    actions: [
      'wait for #tab-case-information to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-20&info=statistics',
  },
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19/add-other-statistics',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-20/add-deficiency-statistics',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19/edit-other-statistics',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-20/edit-deficiency-statistic/cb557361-50ee-4440-aaff-0a9f1bfa30ed',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/105-20/edit-deficiency-statistic/cb557361-50ee-4440-aaff-0a9f1bfa30ed&info=delete-deficiency-modal',
  },
  {
    actions: [
      'wait for button.red-warning to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19/edit-other-statistics&info=delete-other-statistics-modal',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/102-19/case-information&info=sealed-address-display',
  },

  /* petition qc */
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/104-19/petition-qc?tab=partyInfo',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/104-19/petition-qc?tab=caseInfo',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/102-19/petition-qc?tab=irsNotice&info=reveal-notice-options',
  },
  {
    actions: [
      'wait for #tab-irs-notice to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/file-a-petition/step-1&info=statistics-petition-qc',
  },
  {
    actions: [
      'wait for #tab-irs-notice to be visible',
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/file-a-petition/step-1&info=penalties-modal',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/121-20/petition-qc',
  },

  /* review petition */
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/104-19/documents/c63be3f2-2240-451e-b6bd-8206d52a070b/review',

  /* trial sessions */
  {
    actions: ['wait for #trial-sessions-tabs to be visible'],
    notes: 'checks a11y of trial sessions table list',
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/trial-sessions&info=list-trial-sessions',
  },
  {
    actions: [
  ...
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/trial-session-detail/5b18af9e-4fbd-459b-8db7-7b15108c7fa5&info=non-calendared-case',

  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/case-detail/101-19/edit-order/25100ec6-eeeb-4e88-872f-c99fad1fe6c7/sign',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/reports/blocked-cases&info=blocked-cases-alabama',
  },
  // this url probably needs to be moved to calendaring when those users are created
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/reports/case-deadlines',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/search&info=trial-session-planning-modal',
  },
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/edit-trial-session/6b6975cf-2b10-4e84-bcae-91e162d2f9d1',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/trial-session-detail/5b18af9e-4fbd-459b-8db7-7b15108c7fa5&info=qc-complete-checkboxes',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/search&info=practitioner-search-results',
  },
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/practitioner-detail/PT1234',
  /* messages */
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/my/inbox&info=messages-inbox',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/my/outbox&info=messages-outbox',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/section/inbox&info=messages-section-inbox',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/section/outbox&info=messages-section-outbox',
  'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/105-20/message-detail/eb0a139a-8951-4de1-8b83-f02a27504105&info=case-message-detail',
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/105-20/message-detail/eb0a139a-8951-4de1-8b83-f02a27504105&info=message-detail-forward',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/105-20/message-detail/eb0a139a-8951-4de1-8b83-f02a27504105&info=message-detail-reply',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/log-in?code=petitionsclerk@example.com&path=/messages/105-20/message-detail/eb0a139a-8951-4de1-8b83-f02a27504105&info=message-detail-complete',
  },
];
