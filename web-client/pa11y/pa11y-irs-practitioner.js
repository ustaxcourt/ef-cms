module.exports = [
  ...
  'http://localhost:1234/mock-login?token=irsPractitioner&path=/case-detail/101-19',
  {
    ...
    url: 'http://localhost:1234/mock-login?token=irsPractitioner&path=/case-detail/104-18&info=can-file-document',
  },
  {
    actions: [
    ...
    url: 'http://localhost:1234/mock-login?token=irsPractitioner&path=/case-detail/102-20&info=associated-respondent',
  },
