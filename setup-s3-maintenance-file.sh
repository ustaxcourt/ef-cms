...
# maintenance_notify is ONLY on east
aws s3 cp s3://${BUCKET_NAME}/maintenance_notify_${DEPLOYING_COLOR}.js.zip s3://${BUCKET_NAME}/maintenance_notify_${CURRENT_COLOR}.js.zip