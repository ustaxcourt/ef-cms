...
| docket number generator counter                            | docketNumberCounter-2021                        | docketNumberCounter-${YEAR}              |                                             |
| associate a irs practitioner onto a case                   | case\|${CASE_ID}                                | irsPractitioner\|${USER_ID}              |                                             |
...
| add a case not to the user                                 | user-case-note\|${USER}                         | user\|${USER_ID}                         |                                             |
