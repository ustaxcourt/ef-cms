...
`opensearch` has its latest version erroneously listed as `1.2.0`, and the [maintainers acknowledge this error](https://github.com/opensearch-project/opensearch-js/issues/521). The correct latest version as of 05/31/23 is `2.2.1`.
