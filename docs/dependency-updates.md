...
- Updating hashicorp/aws version to 6.33.0 in .tf files caused failures during deployment to an expiremental branch so it was reverted back to version 6.32.1.
- upon updating please deploy to an expirimental branch and confirm functionallity.
