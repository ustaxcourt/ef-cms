...
The script associated with this file is only needed for story #7377, once the script has been run on all environments, this file and the script can be deleted.

## Running add-cognito-custom-attribute.sh
