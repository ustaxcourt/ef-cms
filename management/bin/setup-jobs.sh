...
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "ssh -oStrictHostKeyChecking=no bitnami@${JENKINS_PRIVATE_IP} 'sudo su -c \"mkdir -p /opt/bitnami/apps/jenkins/jenkins_home/jobs/ef-cms-ui-deploy\" tomcat'"
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "ssh -oStrictHostKeyChecking=no bitnami@${JENKINS_PRIVATE_IP} 'sudo su -c \"mkdir -p /opt/bitnami/apps/jenkins/jenkins_home/jobs/ef-cms-api-deploy\" tomcat'"
...
scp ../jobs/ef-cms-ui-deploy/config.xml ubuntu@${BASTION_PUBLIC_IP}:/home/ubuntu/ef-cms-ui-deploy-config.xml
scp ../jobs/ef-cms-api-deploy/config.xml ubuntu@${BASTION_PUBLIC_IP}:/home/ubuntu/ef-cms-api-deploy-config.xml
...
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "scp /home/ubuntu/ef-cms-ui-deploy-config.xml bitnami@${JENKINS_PRIVATE_IP}:/home/bitnami"
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "scp /home/ubuntu/ef-cms-api-deploy-config.xml bitnami@${JENKINS_PRIVATE_IP}:/home/bitnami"
...
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "ssh -oStrictHostKeyChecking=no bitnami@${JENKINS_PRIVATE_IP} 'sudo su -c \"cp /home/bitnami/ef-cms-ui-deploy-config.xml /opt/bitnami/apps/jenkins/jenkins_home/jobs/ef-cms-ui-deploy/config.xml\" tomcat'"
ssh -A -oStrictHostKeyChecking=no ubuntu@${BASTION_PUBLIC_IP} "ssh -oStrictHostKeyChecking=no bitnami@${JENKINS_PRIVATE_IP} 'sudo su -c \"cp /home/bitnami/ef-cms-api-deploy-config.xml /opt/bitnami/apps/jenkins/jenkins_home/jobs/ef-cms-api-deploy/config.xml\" tomcat'"
