...
nodemon -e js,ts --ignore web-client/ --ignore dist/ --ignore dist-public/ --ignore cypress/ --exec "npx ts-node --transpile-only --node-args '--inspect=0.0.0.0:9230' web-api/src/app-local.ts"
