...
RUN wget -q -O terraform_0.14.9_linux_amd64.zip https://releases.hashicorp.com/terraform/0.14.9/terraform_0.14.9_linux_amd64.zip && \
  unzip -o terraform_0.14.9_linux_amd64.zip terraform && \
