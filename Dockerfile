...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.11.11.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip

RUN pip install --upgrade pip
RUN wget -q -O terraform.zip https://releases.hashicorp.com/terraform/1.4.4/terraform_1.4.4_linux_amd64.zip && \
