...
FROM cypress/browsers:node-24.18.0-chrome-149.0.7827.155-1-ff-152.0-edge-149.0.4022.80-1
WORKDIR /home/app
...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.35.11.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip
