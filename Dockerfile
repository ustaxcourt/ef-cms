...
RUN wget -q -O terraform_0.13.6_linux_amd64.zip https://releases.hashicorp.com/terraform/0.13.6/terraform_0.13.6_linux_amd64.zip && \
  unzip -o terraform_0.13.6_linux_amd64.zip terraform && \
