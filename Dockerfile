...
FROM cypress/browsers:node-22.14.0-chrome-135.0.7049.114-1-ff-137.0.2-edge-135.0.3179.85-1
...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.27.9.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip
