...
FROM cypress/browsers:node-24.16.0-chrome-149.0.7827.102-1-ff-151.0.4-edge-149.0.4022.52-1
WORKDIR /home/app
...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.35.5.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip
