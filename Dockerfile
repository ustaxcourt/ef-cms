...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.15.9.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip

RUN pip install --upgrade pip
RUN wget -q -O terraform.zip https://releases.hashicorp.com/terraform/1.7.0/terraform_1.7.0_darwin_amd64.zip && \ 
