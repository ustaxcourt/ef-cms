...
RUN wget -q -O terraform_0.13.2_linux_amd64.zip https://releases.hashicorp.com/terraform/0.13.2/terraform_0.13.2_linux_amd64.zip && \
  unzip -o terraform_0.13.2_linux_amd64.zip terraform && \
